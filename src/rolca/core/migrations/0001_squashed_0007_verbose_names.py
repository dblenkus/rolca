...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_add_contest_description'), ('core', '0003_contest_login_required'), ('core', '0004_author_email'), ('core', '0005_nonrequired_user'), ('core', '0006_photo_title_not_required'), ('core', '0007_verbose_names')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.CharField(blank=True, max_length=60, null=True, verbose_name='Mentor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Theme')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
